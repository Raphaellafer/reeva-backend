...
<reference>
@C:/Users/lafer/reeva/reeva-backend/.codex/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `C:/Users/lafer/reeva/reeva-backend/.codex/get-shit-done/references/user-profiling.md` to load:
