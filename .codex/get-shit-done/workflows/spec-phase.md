...
```bash
INIT=$(node "C:/Users/lafer/reeva/reeva-backend/.codex/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @C:/Users/lafer/reeva/reeva-backend/.codex/get-shit-done/templates/spec.md.
