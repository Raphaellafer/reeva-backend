...
INSTALL_JS_GLOBAL="C:/Users/lafer/reeva/reeva-backend/.codex/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node C:/Users/lafer/reeva/reeva-backend/.codex/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
