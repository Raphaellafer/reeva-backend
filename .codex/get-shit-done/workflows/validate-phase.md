...
```
Task(
  prompt="Read C:/Users/lafer/reeva/reeva-backend/.codex/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Users/lafer/reeva/reeva-backend/.codex/get-shit-done/templates/VALIDATION.md`
